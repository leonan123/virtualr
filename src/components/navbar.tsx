      ...
      <div className="container px-4 mx-auto relative text-sm">
        <div className="flex justify-between items-center">
          <div className="flex items-center flex-shrink-0">
            <img src={logo} alt="" className="size-10 mr-2" />
          ...
          <div className="lg:hidden md:flex flex-col justify-end">
            <button onClick={toggleNavbar} className="cursor-pointer">
              {mobileDrawerOpen ? (
                <>
                  <X className="transition-all from-transparent to-current" />
                  <span className="sr-only">Close Menu</span>
                </>
              ) : (
                <>
                  <Menu className="transition-all from-transparent to-current" />
